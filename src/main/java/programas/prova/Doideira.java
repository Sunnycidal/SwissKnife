...
public class Doideira {
    ...
    public static void main(String[] args) {
        ...
        String carrinho;
        double $1 = 10000.00, $2 = 180.00, $3 = 450.00, $4 = 270.00, $5 = 390.00,
                subTotal = 0;
        ...
        else if(carrinho.matches("^205$"))
        {
            ...
            System.out.println("Opção de código inválida");
            return;
        }
        ...
        if (respostaSeguro.matches("^S$")){adicional += subTotal * 0.06;
        ...
        if (respostaRastreamento.matches("^S$")){adicional += subTotal * 0.04;
        ...
        if (!(regiao.equals("1") || regiao.equals("2"))){
            ...
            if (respostaEscolta.matches("^S$") ){adicional += subTotal * 0.12;
                System.out.println("Adicionamos a escolta armada!");}
            else{System.out.println("Escolta não adicionada");}
        }else{
            System.out.println("Escolta não disponível para as suas regiões");
        }
